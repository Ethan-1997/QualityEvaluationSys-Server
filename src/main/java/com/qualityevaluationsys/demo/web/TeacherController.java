...
public class TeacherController extends BaseController {
    ...
    public Map<String,Object> list(Integer limit, String sort, Integer page, @ModelAttribute Teacher pojo){
        msg.clear();
        try {
    ...
    public Map<String,Object> create(@ModelAttribute Teacher pojo){
        msg.clear();
        try {
    ...
    public Map<String,Object> delete(@ModelAttribute Teacher pojo){
        msg.clear();
        try {
            int i = service.deleteByPrimaryKey(pojo.getTno());
            if(i==1){
                msg.put("data","success");
            }else{
    ...
    public Map<String,Object> get(@ModelAttribute Teacher pojo){
        msg.clear();
        try {
            Teacher temp = service.selectByPrimaryKey(pojo.getTno());
            msg.put("item",temp);
        }catch (Exception e){
            msg.put("data","error");
            msg.put("message",e.getMessage());
    ...
    public Map<String,Object> update(@ModelAttribute Teacher pojo){
        msg.clear();
        try {
